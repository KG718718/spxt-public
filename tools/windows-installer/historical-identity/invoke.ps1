...
$taskAllowedPhases=@(
  ...
  'INSTALL_FOOTPRINT_PAYLOAD_PATH_ORDER',
  'INSTALL_FOOTPRINT_PAYLOAD_PATH_SEPARATOR',
  'INSTALL_FOOTPRINT_PAYLOAD_PATH_CASE',
  'INSTALL_FOOTPRINT_PAYLOAD_PATH_UNICODE',
  'INSTALL_FOOTPRINT_PAYLOAD_PATH_SET',
...
function Invoke-InstalledFootprint {
  ...
  switch($footprintExit){
    ...
    39 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_PATH_ORDER'}
    40 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_PATH_SEPARATOR'}
    41 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_PATH_CASE'}
    42 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_PATH_UNICODE'}
    43 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_PATH_SET'}
    44 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_BYTES'}
    45 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_HASH'}
    46 {Set-TaskPhase 'INSTALL_FOOTPRINT_PAYLOAD_SCHEMA'}
    47 {Set-TaskPhase 'INSTALL_FOOTPRINT_USAGE'}
