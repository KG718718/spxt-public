...
const exits = Object.freeze({
  ...
  IDENTITY_REGISTRATION: 50, IDENTITY_BINDING: 51, IDENTITY_PATH: 52, IDENTITY_MANIFEST: 53,
  IDENTITY_PROGRAM: 54, IDENTITY_BUILD: 55, IDENTITY_RUNTIME: 56, IDENTITY_LAUNCHER: 57, IDENTITY_INTERNAL: 58
});
try {
